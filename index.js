...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5384257195 :+55 53 84257195\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ Calma ae cpx, to fazendo aq�',
				success: '✔️ Sucesso ✔️',
				...
				error: {
					stick: '[❗] Bah o meu, deu algum erro aqui, tenta de novo ae. ❌',
					Iv: '❌ Link inválido ❌'
				},
				only: {
			...
			const ownerNumber = ["5384257195@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5384257195@s.whatsapp.net'
                        /******ApiKey Input******/
